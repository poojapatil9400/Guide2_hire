...
void main() {
  runApp(const Fluttercode());
}

class Fluttercode extends StatefulWidget {
  const Fluttercode({super.key});
  @override
  State createState() => _FluttercodeState();
}

class _FluttercodeState extends State<Fluttercode> {
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.quicksand(
                                ...
                                fontWeight: FontWeight.w700,
                                fontSize:
                                    20, // Slightly larger font for the question
                              ),
                            ),
