...
void main() {
  runApp(const JavaCode());
}

class JavaCode extends StatefulWidget {
  const JavaCode({super.key});
  @override
  State createState() => _JavaCodeState();
}

class _JavaCodeState extends State<JavaCode> {
